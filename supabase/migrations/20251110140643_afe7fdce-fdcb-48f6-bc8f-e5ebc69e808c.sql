...
-- Fix normalize_country_name function (missing search_path)
CREATE OR REPLACE FUNCTION public.normalize_country_name(country text)
RETURNS text
LANGUAGE plpgsql
IMMUTABLE
...
-- Update manage_client_folder to include extensions schema
